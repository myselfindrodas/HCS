...
class Changepassword : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        changepasswordBinding.btnUpdatepassword.setOnClickListener {
            ...
            if (changepasswordBinding.etNewpassword.text.length<=7){
                Toast.makeText(this, "Enter New Password must be at least 8 characters.", Toast.LENGTH_SHORT).show()
            }else if (changepasswordBinding.etConfirmpassword.text.length<=7){
