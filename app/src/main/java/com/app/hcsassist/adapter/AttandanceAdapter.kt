    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        with(holder){
            ...
            modelList[position].let { modelItem->
                ...
                if (modelItem.punchOutTime==null || modelItem.punchOutTime.isNullOrEmpty()){
                ...
                if (modelItem.punchInTime!!.isNullOrEmpty() && modelItem.punchOutTime!!.isNullOrEmpty()){
                    ...
                    if (modelItem.punchOutTime==null || modelItem.punchOutTime.isEmpty()){
                        timeRange.text=modelItem.punchInTime
                    }else{
                        timeRange.text="${modelItem.punchInTime} - ${modelItem.punchOutTime}"
                    }
                }
            }
        }
